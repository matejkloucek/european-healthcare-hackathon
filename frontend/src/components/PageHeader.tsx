    ...
    <AppBar position={"static"}>
      ...
      >
        <Stack direction={"row"} alignItems={"center"}>
          <HistoryEduIcon fontSize={"large"} sx={{fontSize: 40}}/>
          <Typography fontWeight={FontWeight.Bold} fontSize={25}>
            disquill
          </Typography>

        </Stack>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 158.67 56.98" height={"40px"} fill={"#ffffff"}>
          <g id="Vrstva_2" data-name="Vrstva 2">
            <g id="Vrstva_1-2" data-name="Vrstva 1">
              <polygon points="124.93 26.95 124.93 10.57 117.69 10.57 117.69 14.58 120.4 14.58 120.4 26.95 124.93 26.95"/>
              ...
              <path d="M134.22,48.09A2.76,2.76,0,0,1,131.41,51a2.7,2.7,0,0,1-2.72-2.86V38.58h-4.56v11a5.61,5.61,0,0,0,5.78,5.78,4.72,4.72,0,0,0,4-1.89h.32V55h4.55V38.58h-4.55Z" />
              <polygon points="131.48 7.71 131.48 22.94 128.61 22.94 128.61 26.98 138.91 26.98 138.91 22.94 136.04 22.94 136.04 7.76 139.13 7.76 139.13 3.67 131.48 3.67 131.48 7.71" />
              ...
              <path d="M121.84,8.7a4.35,4.35,0,1,0-4.37-4.35A4.35,4.35,0,0,0,121.84,8.7Zm0-6.28a1.94,1.94,0,1,1-1.94,1.93A1.94,1.94,0,0,1,121.84,2.42Z"/>
